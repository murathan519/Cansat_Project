...
#define SEA_LEVEL_PRESSURE 1008 // ÝTÜ 1008 hPa
...
int main()
{
	...
	while (1)
	{
		...
		*/
		...
		FILE *ms5611WriteFile = fopen("/home/pi/Desktop/TURKSAT/MS5611data.txt", "w");
		fprintf(ms5611WriteFile, "%f %f %f %f", fltd_Temparature, fltd_Pressure*100, Altitude, roc/100.0);
		fclose(ms5611WriteFile);
